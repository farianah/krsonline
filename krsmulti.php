		...
		<table border="1" cellspacing="0">
			...
			<?php
				...
				while ($row=mysqli_fetch_array($resultmhs, MYSQLI_ASSOC)){
					...
					echo "<td><a href='editkrs.php?idkrs=$row[idkrs]'><img src=edit.png width=30></a></td>";
					echo "<td><a href='deletekrs.php?idkrs=$row[idkrs]'><img src=delete.png width=30></a></td>";
					echo "</tr>";
			}
